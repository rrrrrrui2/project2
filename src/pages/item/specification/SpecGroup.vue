...
export default {
  ...
  methods:{
      loadData(){
          this.$http.get("/item-services/spec/groups/" + this.cid)
          .then(({data}) => {
              this.groups = data;
          })
          .catch(() => {
      ...
      save(){
           this.$http({
            ...
            url: this.isEdit ? '/item-services/spec/group/edit':'/item-services/spec/group/add',
            data: this.group
          }).then(() => {
            // 关闭窗口
            this.show = false;
      ...
      deleteGroup(id){
          ...
          .then(() => {
            this.$http.delete("/item-services/spec/group/delete/" + id)
                .then(() => {
